import numpy as np
import lepm.chern.kchern_gyro_fns as kcgfns
...
'''Class for k-space Chern calculations --> need to adapt to be tight-binding instead of gyro_lattice based!'''
...
class KChern:
    ...
    def __init__(self, gyro_lattice, cp=None, cpmeshfn=None):
        raise RuntimeError('need to adapt for tight binding')
    ...
    def get_chern(self, attribute=True):
