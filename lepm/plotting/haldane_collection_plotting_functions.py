...
"""Auxiliary functions for plotting haldane_collections, such as overlaying colored DOS histograms.
"""
    ...
    **kwargs: lepm.plotting.plotting.colored_DOS_plot() keyword arguments
    ...
    for ii in range(len(gcoll.gyro_lattices)):
        ...
        if ii == 0 and dos_ax is None:
            ...
            fig, dos_ax, cax, cbar = leplt.initialize_colored_DOS_plot(eigval, 'haldane', pin=-5000,
            ...
            leplt.colored_DOS_plot(eigval, dos_ax, 'haldane', pin=-5000, alpha=alpha, colorV=ill, cbar_ax=cbar_ax,
