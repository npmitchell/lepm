...
if lp['check']:
    ...
    le.plot_complex_matrix(pp, show=True, name=r'$P$', fontsize=fsfs)
    le.plot_real_matrix(np.abs(pp), show=True, name=r'$|P|$', fontsize=fsfs)
    le.plot_complex_matrix(uu, show=True, name=r'$U$', fontsize=fsfs)
    le.plot_complex_matrix(vv, show=True, name=r'$V$', fontsize=fsfs)
