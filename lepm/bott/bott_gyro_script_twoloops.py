...
for nsize in results:
    ax.plot(results[nsize][:, 0], results[nsize][:, 1], marker=markers[kk], linestyle=lines[kk],
            markersize=1, markeredgecolor=None, label=str(nsize))
    kk += 1
...
ax.set_title(r'Topological phase transition')
...
if alternative:
    name = '/Users/npmitchell/Desktop/temp/gyro_series/' + gyrodirty + '_shorthand' + addstr
else:
    name = '/Users/npmitchell/Desktop/temp/gyro_series/' + gyrodirty + addstr

plt.savefig(name + '_abtransition.png', dpi=300)
...
plt.savefig(name + '_abtransition_zoom.png', dpi=300)
# plt.show()
#
